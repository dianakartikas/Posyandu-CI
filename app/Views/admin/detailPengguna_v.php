            ...
            <div class="card-body">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Detail Profile </h5>
                                ...
                                <div class="card-footer">
                                    <a href=" <?= base_url('admin'); ?>" class="btn btn-primary"> <i class="fas fa-backward"> </i> back to user list</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title text-info">Detail Anak</h5>
                                        <p class="card-text">Informasi mengenai data user Sistem Informasi Posyandu, ganti gambar profile dengan tombol "upload gambar" jika dibutuhkan.</p>
                                        <ul class="list-group list-group-flush">
                                        ...
                                        <div class="card-footer row">
                                            <div class="col-md-8">
                                                <a data-toggle="modal" data-target="#formModalEditAnak<?= $row['id_anak']; ?>" class="btn btn-primary"> <i class="fas fa-pencil-alt"> </i> Edit</a>
                                            </div>
                                            <div class="col-md-4">
                                                <button class="btn btn-danger" onclick="hapus('<?= $row['id_anak']; ?>')"> <i class="fas fa-trash"></i> Hapus</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
