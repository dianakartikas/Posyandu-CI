    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="get" action="">
                ...
                <a href="/cetakpertumbuhan" class="btn btn-secondary">Reset Filter</a>
            </form>
            <hr />
                        ...
                        <tbody>
                            ...
                            if (!empty($cetak)) {
                                ...
                                foreach ($cetak as $data) {
                                    ...
                                    echo "<td>" . $data->hasil_bbu . "</td>";
                                    echo "<td>" . $data->hasil_tbu . "</td>";
                                    echo "<td>" . $data->hasil_bbtb . "</td>";
