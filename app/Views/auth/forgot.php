    ...
    <nav class="navbar navbar-dark bg-primary">
        <div>
            <div class="container-fluid">
                <a class="navbar-brand" href="#">SIPOSYANDU</a>

                <a class="navbar-item text-white" href="/">
                    <i class="fas fa-users"></i> Anggota | Login
                </a>
            </div>
        </div>
    </nav>
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mb-3">Masukkan alamat email, link reset akan dikirim ke email Anda</p>
                            </div>
                            <form class="user" action="<?= route_to('forgot') ?>" method="post">
                                ...
                                <button href="/login" class="btn btn-primary btn-block"><?= lang('Auth.sendInstructions') ?></button>
                            </form>
                            <hr>
                            <div class="text-center">
